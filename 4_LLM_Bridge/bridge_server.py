...
try:
    FAST_LIVE_BASELINE_TIMEOUT_SEC = int(os.environ.get("FAST_LIVE_BASELINE_TIMEOUT_SEC", "6"))
except ValueError:
    FAST_LIVE_BASELINE_TIMEOUT_SEC = 6
try:
    FAST_LIVE_BASELINE_TIMEOUT_FLOP_SEC = int(os.environ.get("FAST_LIVE_BASELINE_TIMEOUT_FLOP_SEC", "5"))
except ValueError:
    FAST_LIVE_BASELINE_TIMEOUT_FLOP_SEC = 5
try:
    FAST_LIVE_BASELINE_TIMEOUT_TURN_SEC = int(os.environ.get("FAST_LIVE_BASELINE_TIMEOUT_TURN_SEC", "4"))
except ValueError:
    FAST_LIVE_BASELINE_TIMEOUT_TURN_SEC = 4
try:
    FAST_LIVE_BASELINE_TIMEOUT_RIVER_SEC = int(os.environ.get("FAST_LIVE_BASELINE_TIMEOUT_RIVER_SEC", "3"))
except ValueError:
    FAST_LIVE_BASELINE_TIMEOUT_RIVER_SEC = 3
try:
    FAST_LIVE_ACTIVE_NODE_TIMEOUT_SEC = int(os.environ.get("FAST_LIVE_ACTIVE_NODE_TIMEOUT_SEC", "6"))
except ValueError:
    FAST_LIVE_ACTIVE_NODE_TIMEOUT_SEC = 6
try:
    FAST_LIVE_ACTIVE_NODE_FLOP_TIMEOUT_SEC = int(os.environ.get("FAST_LIVE_ACTIVE_NODE_FLOP_TIMEOUT_SEC", "8"))
except ValueError:
    FAST_LIVE_ACTIVE_NODE_FLOP_TIMEOUT_SEC = 8
...
try:
    FAST_LIVE_LOCKED_TIMEOUT_SEC = int(os.environ.get("FAST_LIVE_LOCKED_TIMEOUT_SEC", "3"))
except ValueError:
    FAST_LIVE_LOCKED_TIMEOUT_SEC = 3
try:
    FAST_LIVE_LOCKED_STAGE_TOTAL_SEC = int(os.environ.get("FAST_LIVE_LOCKED_STAGE_TOTAL_SEC", "8"))
except ValueError:
    FAST_LIVE_LOCKED_STAGE_TOTAL_SEC = 8
try:
...
try:
    FAST_LIVE_SPOT_MAX_RAISE_CAP = int(os.environ.get("FAST_LIVE_SPOT_MAX_RAISE_CAP", "3"))
except ValueError:
    FAST_LIVE_SPOT_MAX_RAISE_CAP = 3
try:
...
FAST_LIVE_SPOT_BET_SIZES_RAW = os.environ.get("FAST_LIVE_SPOT_BET_SIZES", "0.33,0.75,1.0")
FAST_LIVE_SPOT_RAISE_SIZES_RAW = os.environ.get("FAST_LIVE_SPOT_RAISE_SIZES", "1.0,2.0,2.5")
