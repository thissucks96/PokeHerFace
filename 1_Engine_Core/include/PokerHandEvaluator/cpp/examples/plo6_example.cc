...
int main() {
   ...
   * Player 1: 2c 9c As Kd Jh 8d
   * Player 2: 6s 9s Ts Js 2s 2d
   */
  phevaluator::Rank rank1 = phevaluator::EvaluatePlo6Cards(
      "4c", "5c", "6c", "7s", "8s",         // community cards
      "2c", "9c", "As", "Kd", "Jh", "8d");  // player hole cards
  phevaluator::Rank rank2 = phevaluator::EvaluatePlo6Cards(
      "4c", "5c", "6c", "7s", "8s",         // community cards
