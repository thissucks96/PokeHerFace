#!/usr/bin/env python3
"""Train local neural policy model from solver-teacher rows.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train local neural policy from solver-teacher rows.")
    parser.add_argument(
        "--config",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Input JSONL generated by build_neural_dataset.py --write.",
    )
